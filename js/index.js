...
$(document).ready(function () {
  ...
  $(".congratulation-image").hover(function () {
    counterImg++;
    if (counterImg % 1 == 2) {
      $(this).attr("src", "img/Polly.jpg");
    } else if (counterImg % 3 ==1) {
      $(this).attr("src", "img/Polly2.jpg");
    }else if (counterImg % 4 ==1){
      $(this).attr("src", "img/Polly3.jpg");
    }else if (counterImg % 5 ==1){
      $(this).attr("src", "img/Polly4.jpg");
    } else if (counterImg % 6==2){
      $(this).attr("src","img/Polly5.jpg");
    } else if (counterImg % 7==1){
      $(this).attr("src","img/Polly6.jpg");
